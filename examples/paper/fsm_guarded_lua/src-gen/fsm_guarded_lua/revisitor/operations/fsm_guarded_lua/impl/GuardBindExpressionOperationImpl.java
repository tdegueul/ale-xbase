package fsm_guarded_lua.revisitor.operations.fsm_guarded_lua.impl;
...
import fsm_guarded_lua.revisitor.Fsm_guarded_luaRevisitor;
...
public class GuardBindExpressionOperationImpl implements GuardBindExpressionOperation {
  ...
  public boolean eval(final Context ctx) {
    fsm_guarded_lua.converters.GuardToExpressionWithevalToexecute convert =  new fsm_guarded_lua.converters.GuardToExpressionWithevalToexecute(ctx);
    
    
    org.xtext.lua.semantics.model.Environment cp = convert.adaptc();
    convert.setCp(cp);
    
    
    alg.$(obj.getDelegate()).execute(cp);
    boolean res = convert.convertReturn(); 
