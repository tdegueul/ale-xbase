 ...
 * @generated
 */
public class TokenHolderSwitch<T1> extends Switch<T1> {
	/**
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TokenHolderPackage.H: {
				H h = (H)theEObject;
				T1 result = caseH(h);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TokenHolderPackage.T: {
				T t = (T)theEObject;
				T1 result = caseT(t);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TokenHolderPackage.P: {
				P p = (P)theEObject;
				T1 result = caseP(p);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TokenHolderPackage.R: {
				R r = (R)theEObject;
				T1 result = caseR(r);
				if (result == null) result = defaultCase(theEObject);
				return result;
