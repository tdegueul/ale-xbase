...
public class ActivityImpl extends NamedElementImpl implements Activity {
	...
	private void initializeTrace() {
		Trace trace = ActivitydiagramFactory.eINSTANCE.createTrace();
		this.setTrace(trace);
	}
...
//		System.out.println("fire node " + node.getName());
		...
		node.fire(tokens);
		getTrace().getExecutedNodes().add(node);
	}
	 ...
	 */
	@Override
	public ActivityNode selectNextNode(List<ActivityNode> activityNodes) {
