...
import adwithoutruntime.IntegerCalculationOperator;
 ...
 * @generated
 */
public class AdwithoutruntimePackageImpl extends EPackageImpl implements AdwithoutruntimePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see adwithoutruntime.AdwithoutruntimePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AdwithoutruntimePackageImpl() {
		super(eNS_URI, AdwithoutruntimeFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link AdwithoutruntimePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AdwithoutruntimePackage init() {
		if (isInited) return (AdwithoutruntimePackage)EPackage.Registry.INSTANCE.getEPackage(AdwithoutruntimePackage.eNS_URI);

		// Obtain or create and register package
		AdwithoutruntimePackageImpl theAdwithoutruntimePackage = (AdwithoutruntimePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AdwithoutruntimePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AdwithoutruntimePackageImpl());

		isInited = true;

		// Create package meta-data objects
		theAdwithoutruntimePackage.createPackageContents();

		// Initialize created meta-data
		theAdwithoutruntimePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theAdwithoutruntimePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AdwithoutruntimePackage.eNS_URI, theAdwithoutruntimePackage);
		return theAdwithoutruntimePackage;
	}
	 ...
	 * @generated
	 */
	public AdwithoutruntimeFactory getAdwithoutruntimeFactory() {
		return (AdwithoutruntimeFactory)getEFactoryInstance();
	}
