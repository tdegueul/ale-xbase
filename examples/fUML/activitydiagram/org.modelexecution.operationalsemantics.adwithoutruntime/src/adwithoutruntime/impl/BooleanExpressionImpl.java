 ...
 * </p>
 * <ul>
 *   <li>{@link adwithoutruntime.impl.BooleanExpressionImpl#getAssignee <em>Assignee</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BooleanExpressionImpl extends ExpressionImpl implements BooleanExpression {
	...
	protected EClass eStaticClass() {
		return AdwithoutruntimePackage.Literals.BOOLEAN_EXPRESSION;
	}
		...
		if (assignee != null && assignee.eIsProxy()) {
			...
			if (assignee != oldAssignee) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AdwithoutruntimePackage.BOOLEAN_EXPRESSION__ASSIGNEE, oldAssignee, assignee));
			}
		}
		return assignee;
	}
	...
	public void setAssignee(BooleanVariable newAssignee) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdwithoutruntimePackage.BOOLEAN_EXPRESSION__ASSIGNEE, oldAssignee, assignee));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AdwithoutruntimePackage.BOOLEAN_EXPRESSION__ASSIGNEE:
