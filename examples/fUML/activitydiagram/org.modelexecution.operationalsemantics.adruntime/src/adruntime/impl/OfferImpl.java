 ...
 * </p>
 * <ul>
 *   <li>{@link adruntime.impl.OfferImpl#getOfferedTokens <em>Offered Tokens</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OfferImpl extends MinimalEObjectImpl.Container implements Offer {
	...
	protected EClass eStaticClass() {
		return AdruntimePackage.Literals.OFFER;
	}
	...
	public EList<Token> getOfferedTokens() {
		if (offeredTokens == null) {
			offeredTokens = new EObjectResolvingEList<Token>(Token.class, this, AdruntimePackage.OFFER__OFFERED_TOKENS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AdruntimePackage.OFFER__OFFERED_TOKENS:
