 ...
 * </p>
 * <ul>
 *   <li>{@link adruntime.impl.InputImpl#getInputValues <em>Input Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputImpl extends MinimalEObjectImpl.Container implements Input {
	...
	protected EClass eStaticClass() {
		return AdruntimePackage.Literals.INPUT;
	}
	...
	public EList<InputValue> getInputValues() {
		if (inputValues == null) {
			inputValues = new EObjectContainmentEList<InputValue>(InputValue.class, this, AdruntimePackage.INPUT__INPUT_VALUES);
		}
		return inputValues;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdruntimePackage.INPUT__INPUT_VALUES:
