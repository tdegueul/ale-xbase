 ...
 *   <li>{@link fsm.impl.TransitionImpl#getOwning <em>Owning</em>}</li>
...
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	...
	public Machine getOwning() {
		if (eContainerFeatureID() != FsmPackage.TRANSITION__OWNING) return null;
	...
	public NotificationChain basicSetOwning(Machine newOwning, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwning, FsmPackage.TRANSITION__OWNING, msgs);
		return msgs;
	}
	...
	public void setOwning(Machine newOwning) {
		if (newOwning != eInternalContainer() || (eContainerFeatureID() != FsmPackage.TRANSITION__OWNING && newOwning != null)) {
			...
			if (newOwning != null)
				msgs = ((InternalEObject)newOwning).eInverseAdd(this, FsmPackage.MACHINE__TRANSITIONS, Machine.class, msgs);
			msgs = basicSetOwning(newOwning, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TRANSITION__OWNING, newOwning, newOwning));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FsmPackage.TRANSITION__OWNING:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case FsmPackage.TRANSITION__OWNING:
				return eInternalContainer().eInverseRemove(this, FsmPackage.MACHINE__TRANSITIONS, Machine.class, msgs);
		}
