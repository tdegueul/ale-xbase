 ...
 *   <li>{@link fsm.impl.StateImpl#getOwning <em>Owning</em>}</li>
...
public class StateImpl extends MinimalEObjectImpl.Container implements State {
	...
	public Machine getOwning() {
		if (eContainerFeatureID() != FsmPackage.STATE__OWNING) return null;
	...
	public NotificationChain basicSetOwning(Machine newOwning, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwning, FsmPackage.STATE__OWNING, msgs);
		return msgs;
	}
	...
	public void setOwning(Machine newOwning) {
		if (newOwning != eInternalContainer() || (eContainerFeatureID() != FsmPackage.STATE__OWNING && newOwning != null)) {
			...
			if (newOwning != null)
				msgs = ((InternalEObject)newOwning).eInverseAdd(this, FsmPackage.MACHINE__STATES, Machine.class, msgs);
			msgs = basicSetOwning(newOwning, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.STATE__OWNING, newOwning, newOwning));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case FsmPackage.STATE__OWNING:
				return eInternalContainer().eInverseRemove(this, FsmPackage.MACHINE__STATES, Machine.class, msgs);
		}
