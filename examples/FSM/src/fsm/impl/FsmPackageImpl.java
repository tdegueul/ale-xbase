...
public class FsmPackageImpl extends EPackageImpl implements FsmPackage {
	 ...
	 * @generated
	 */
	public EReference getState_Owning() {
	 ...
	 * @generated
	 */
	public EReference getTransition_Owning() {
	...
	public void createPackageContents() {
		...
		createEReference(stateEClass, STATE__OWNING);
		...
		createEReference(transitionEClass, TRANSITION__OWNING);
	...
	public void initializePackageContents() {
		...
		initEReference(getMachine_States(), this.getState(), this.getState_Owning(), "states", null, 0, -1, Machine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMachine_Transitions(), this.getTransition(), this.getTransition_Owning(), "transitions", null, 0, -1, Machine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getState_Owning(), this.getMachine(), this.getMachine_States(), "owning", null, 1, 1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTransition_Owning(), this.getMachine(), this.getMachine_Transitions(), "owning", null, 1, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
