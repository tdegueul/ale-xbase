 ...
 * @generated
 */
public class Ale1Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Ale1Package.RA1: {
				RA1 ra1 = (RA1)theEObject;
				T result = caseRA1(ra1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ale1Package.RA2: {
				RA2 ra2 = (RA2)theEObject;
				T result = caseRA2(ra2);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
