 ...
 * </p>
 * <ul>
 *   <li>{@link simplea.impl.AImpl#getBs <em>Bs</em>}</li>
 *   <li>{@link simplea.impl.AImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AImpl extends MinimalEObjectImpl.Container implements A {
	...
	protected EClass eStaticClass() {
		return SimpleaPackage.Literals.A;
	}
	...
	public EList<B> getBs() {
		if (bs == null) {
			bs = new EObjectContainmentEList<B>(B.class, this, SimpleaPackage.A__BS);
		}
		return bs;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleaPackage.A__NAME, oldName, name));
	}
