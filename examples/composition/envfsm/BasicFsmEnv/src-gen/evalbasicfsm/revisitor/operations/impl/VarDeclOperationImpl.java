...
public class VarDeclOperationImpl implements VarDeclOperation {
  ...
  public VarDeclOperationImpl(final VarDecl obj, final BasicFsmEnvRevisitor<ActionOperation, GuardOperation, StateOperation, MachineOperation, StateOperation, TransOperation, VarDeclOperation> alg) {
    this.obj = obj;
    this.alg = alg;
  }
