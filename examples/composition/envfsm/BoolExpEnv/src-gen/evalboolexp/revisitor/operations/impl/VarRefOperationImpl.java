...
public class VarRefOperationImpl extends ExpOperationImpl implements VarRefOperation {
  ...
  public VarRefOperationImpl(final VarRef obj, final BoolExpEnvRevisitor<AndOperation, ExpOperation, ExpOperation, FalsOperation, ExpOperation, NotOperation, OrOperation, TruOperation, VarRefOperation> alg) {
    super(obj, alg);
    this.obj = obj;
    this.alg = alg;
  }
