...
public class NotOperationImpl extends ExpOperationImpl implements NotOperation {
  ...
  public NotOperationImpl(final Not obj, final BoolExpEnvRevisitor<AndOperation, ExpOperation, ExpOperation, FalsOperation, ExpOperation, NotOperation, OrOperation, TruOperation, VarRefOperation> alg) {
    super(obj, alg);
    this.obj = obj;
    this.alg = alg;
  }
