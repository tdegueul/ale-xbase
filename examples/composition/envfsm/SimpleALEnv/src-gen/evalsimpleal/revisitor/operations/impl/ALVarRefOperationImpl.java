...
public class ALVarRefOperationImpl extends ArithOperationImpl implements ALVarRefOperation {
  ...
  public ALVarRefOperationImpl(final ALVarRef obj, final SimpleALEnvRevisitor<ALVarRefOperation, ArithOperation, ArithLitOperation, ArithMinusOperation, ArithOperation, ArithPlusOperation, AssignOperation, BlockOperation, PrintOperation, StmtOperation> alg) {
    super(obj, alg);
    this.obj = obj;
    this.alg = alg;
  }
