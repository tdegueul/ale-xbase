...
public class ArithPlusOperationImpl extends ArithOpOperationImpl implements ArithPlusOperation {
  ...
  public ArithPlusOperationImpl(final ArithPlus obj, final SimpleALEnvRevisitor<ALVarRefOperation, ArithOperation, ArithLitOperation, ArithMinusOperation, ArithOpOperation, ArithPlusOperation, AssignOperation, BlockOperation, PrintOperation, StmtOperation> alg) {
    super(obj, alg);
    this.obj = obj;
    this.alg = alg;
  }
