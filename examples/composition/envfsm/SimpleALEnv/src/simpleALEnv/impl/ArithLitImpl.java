 ...
 * </p>
 * <ul>
 *   <li>{@link simpleALEnv.impl.ArithLitImpl#getVal <em>Val</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArithLitImpl extends ArithImpl implements ArithLit {
	...
	protected EClass eStaticClass() {
		return SimpleALEnvPackage.Literals.ARITH_LIT;
	}
	...
	public void setVal(int newVal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleALEnvPackage.ARITH_LIT__VAL, oldVal, val));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimpleALEnvPackage.ARITH_LIT__VAL:
				return getVal();
		}
