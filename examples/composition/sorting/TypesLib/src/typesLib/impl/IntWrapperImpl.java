 ...
 * </p>
 * <ul>
 *   <li>{@link typesLib.impl.IntWrapperImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntWrapperImpl extends MinimalEObjectImpl.Container implements IntWrapper {
	...
	protected EClass eStaticClass() {
		return TypesLibPackage.Literals.INT_WRAPPER;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesLibPackage.INT_WRAPPER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TypesLibPackage.INT_WRAPPER__VALUE:
				return getValue();
		}
