...
public class Statement_AssignmentOperationImpl extends Statement_FunctioncallOrAssignmentOperationImpl implements Statement_AssignmentOperation {
  private Statement_Assignment obj;
  ...
  public void execute(final Environment c) {
    Expression _get = this.obj.getVariable().get(0);
    final String variableName = ((Expression_VariableName) _get).getVariable();
    this.alg.$(this.obj.getValues().get(0)).execute(c);
    final Object value = c.popValue();
  ...
  public String print() {
    ...
    {
      String ret = "";
      for (int i = 0; (i < this.obj.getVariable().size()); i++) {
        String _ret = ret;
        Expression _get = this.obj.getVariable().get(i);
        String _plus = (_get + " = ");
        Expression _get_1 = this.obj.getValues().get(i);
