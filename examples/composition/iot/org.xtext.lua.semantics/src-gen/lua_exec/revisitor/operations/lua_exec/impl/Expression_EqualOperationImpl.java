...
public class Expression_EqualOperationImpl extends ExpressionOperationImpl implements Expression_EqualOperation {
  private Expression_Equal obj;
  ...
  public void execute(final Environment c) {
    ...
    c.pushValue(Boolean.valueOf(left.equals(right)));
  }
}
