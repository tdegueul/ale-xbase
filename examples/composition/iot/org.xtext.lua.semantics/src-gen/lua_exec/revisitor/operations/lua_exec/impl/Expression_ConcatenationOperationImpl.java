...
public class Expression_ConcatenationOperationImpl extends ExpressionOperationImpl implements Expression_ConcatenationOperation {
  private Expression_Concatenation obj;
  ...
  public void execute(final Environment c) {
    ...
    final String right = ((String) _popValue_1);
