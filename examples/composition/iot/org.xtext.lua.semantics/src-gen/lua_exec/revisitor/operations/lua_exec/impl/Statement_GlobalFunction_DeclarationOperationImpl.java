...
public class Statement_GlobalFunction_DeclarationOperationImpl extends StatementOperationImpl implements Statement_GlobalFunction_DeclarationOperation {
  private Statement_GlobalFunction_Declaration obj;
  ...
  public void execute(final Environment c) {
    c.putFunction(this.obj.getPrefix().get(0), this.obj.getFunction());
  }
}
