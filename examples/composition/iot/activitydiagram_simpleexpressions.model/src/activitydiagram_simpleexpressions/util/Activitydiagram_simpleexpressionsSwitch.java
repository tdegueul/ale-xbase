 ...
 * @generated
 */
public class Activitydiagram_simpleexpressionsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Activitydiagram_simpleexpressionsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Activitydiagram_simpleexpressionsPackage.EXP_BIND_SE_EXPRESSION: {
				ExpBindSEExpression expBindSEExpression = (ExpBindSEExpression)theEObject;
				T result = caseExpBindSEExpression(expBindSEExpression);
				if (result == null) result = caseExp(expBindSEExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Activitydiagram_simpleexpressionsPackage.BOOLEAN_VARIABLE_BIND_SE_BOOLEAN_VARIABLE: {
			...
			case Activitydiagram_simpleexpressionsPackage.INTEGER_VARIABLE_BIND_SE_INTEGER_VARIABLE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Exp Bind SE Expression</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Exp Bind SE Expression</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExpBindSEExpression(ExpBindSEExpression object) {
		return null;
	}
...
} //Activitydiagram_simpleexpressionsSwitch
