 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.IotOperationDefBindOperationDefImpl#getDelegate <em>Delegate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IotOperationDefBindOperationDefImpl extends MinimalEObjectImpl.Container implements IotOperationDefBindOperationDef {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.IOT_OPERATION_DEF_BIND_OPERATION_DEF;
	}
	...
	public NotificationChain basicSetDelegate(OperationDef newDelegate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.IOT_OPERATION_DEF_BIND_OPERATION_DEF__DELEGATE, oldDelegate, newDelegate);
	...
	public void setDelegate(OperationDef newDelegate) {
		if (newDelegate != delegate) {
			...
			if (delegate != null)
				msgs = ((InternalEObject)delegate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.IOT_OPERATION_DEF_BIND_OPERATION_DEF__DELEGATE, null, msgs);
			if (newDelegate != null)
				msgs = ((InternalEObject)newDelegate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.IOT_OPERATION_DEF_BIND_OPERATION_DEF__DELEGATE, null, msgs);
			msgs = basicSetDelegate(newDelegate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.IOT_OPERATION_DEF_BIND_OPERATION_DEF__DELEGATE, newDelegate, newDelegate));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.IOT_OPERATION_DEF_BIND_OPERATION_DEF__DELEGATE:
