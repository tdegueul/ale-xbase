 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagramruntime.impl.TokenImpl#getHolder <em>Holder</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TokenImpl extends MinimalEObjectImpl.Container implements Token {
	...
	protected EClass eStaticClass() {
		return ActivitydiagramruntimePackage.Literals.TOKEN;
	}
		...
		if (holder != null && holder.eIsProxy()) {
			...
			if (holder != oldHolder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivitydiagramruntimePackage.TOKEN__HOLDER, oldHolder, holder));
			}
		}
		return holder;
	}
	...
	public void setHolder(ActivityNode newHolder) {
		...
		holder = newHolder;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramruntimePackage.TOKEN__HOLDER, oldHolder, holder));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivitydiagramruntimePackage.TOKEN__HOLDER:
