 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagramruntime.impl.TraceImpl#getExecutedNodes <em>Executed Nodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TraceImpl extends MinimalEObjectImpl.Container implements Trace {
	...
	protected EClass eStaticClass() {
		return ActivitydiagramruntimePackage.Literals.TRACE;
	}
	...
	public EList<ActivityNode> getExecutedNodes() {
		if (executedNodes == null) {
			executedNodes = new EObjectResolvingEList<ActivityNode>(ActivityNode.class, this, ActivitydiagramruntimePackage.TRACE__EXECUTED_NODES);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivitydiagramruntimePackage.TRACE__EXECUTED_NODES:
