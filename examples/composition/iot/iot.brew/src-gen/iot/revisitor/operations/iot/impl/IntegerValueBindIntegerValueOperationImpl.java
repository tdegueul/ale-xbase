...
public class IntegerValueBindIntegerValueOperationImpl implements IntegerValueBindIntegerValueOperation {
  private IntegerValueBindIntegerValue obj;
  ...
  public IntegerValueBindIntegerValueOperationImpl(final IntegerValueBindIntegerValue obj, final IotRevisitor<ActionOperation, ActivityOperation, ActivityEdgeOperation, ActivityFinalNodeOperation, ActivityNodeOperation, BooleanBinaryExpressionOperation, BooleanExpressionOperation, BooleanUnaryExpressionOperation, BooleanValueOperation, simpleexpressions_exec.revisitor.operations.simpleexpressions_exec.BooleanValueOperation, BooleanValueBindBooleanValueOperation, BooleanVariableOperation, simpleexpressions_exec.revisitor.operations.simpleexpressions_exec.BooleanVariableOperation, BooleanVariableBindBooleanVariableOperation, ContextOperation, ControlFlowOperation, ControlNodeOperation, ControlTokenOperation, DecisionNodeOperation, ExecutableNodeOperation, ExpressionOperation, simpleexpressions_exec.revisitor.operations.simpleexpressions_exec.ExpressionOperation, ExpressionBindExpressionOperation, FinalNodeOperation, ForkNodeOperation, ForkedTokenOperation, InitialNodeOperation, InputOperation, InputValueOperation, IntegerCalculationExpressionOperation, IntegerComparisonExpressionOperation, IntegerExpressionOperation, IntegerValueOperation, simpleexpressions_exec.revisitor.operations.simpleexpressions_exec.IntegerValueOperation, IntegerValueBindIntegerValueOperation, IntegerVariableOperation, JoinNodeOperation, MergeNodeOperation, NamedElementOperation, OfferOperation, OpaqueActionOperation, TokenOperation, TraceOperation, ValueOperation, simpleexpressions_exec.revisitor.operations.simpleexpressions_exec.ValueOperation, ValueBindValueOperation, VariableOperation, simpleexpressions_exec.revisitor.operations.simpleexpressions_exec.VariableOperation> alg) {
    this.obj = obj;
    this.alg = alg;
  }
}
