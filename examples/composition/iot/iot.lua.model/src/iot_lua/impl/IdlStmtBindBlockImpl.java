 ...
 * </p>
 * <ul>
 *   <li>{@link iot_lua.impl.IdlStmtBindBlockImpl#getDelegate <em>Delegate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdlStmtBindBlockImpl extends MinimalEObjectImpl.Container implements IdlStmtBindBlock {
	...
	protected EClass eStaticClass() {
		return Iot_luaPackage.Literals.IDL_STMT_BIND_BLOCK;
	}
	...
	public NotificationChain basicSetDelegate(Block newDelegate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Iot_luaPackage.IDL_STMT_BIND_BLOCK__DELEGATE, oldDelegate, newDelegate);
	...
	public void setDelegate(Block newDelegate) {
		if (newDelegate != delegate) {
			...
			if (delegate != null)
				msgs = ((InternalEObject)delegate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Iot_luaPackage.IDL_STMT_BIND_BLOCK__DELEGATE, null, msgs);
			if (newDelegate != null)
				msgs = ((InternalEObject)newDelegate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Iot_luaPackage.IDL_STMT_BIND_BLOCK__DELEGATE, null, msgs);
			msgs = basicSetDelegate(newDelegate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Iot_luaPackage.IDL_STMT_BIND_BLOCK__DELEGATE, newDelegate, newDelegate));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Iot_luaPackage.IDL_STMT_BIND_BLOCK__DELEGATE:
