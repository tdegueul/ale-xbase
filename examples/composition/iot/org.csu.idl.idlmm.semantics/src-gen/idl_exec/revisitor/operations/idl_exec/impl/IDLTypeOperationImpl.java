...
public class IDLTypeOperationImpl implements IDLTypeOperation {
  private IDLType obj;
  ...
  public IDLTypeOperationImpl(final IDLType obj, final IdlmmRevisitor<? extends ContainedOperation, ? extends ContainerOperation, ? extends ExceptionDefOperation, ? extends FieldOperation, ? extends IDLTypeOperation, ? extends NamedElementOperation, ? extends OperationDefOperation, ? extends ParameterDefOperation, ? extends PrimitiveDefOperation, ? extends TypedOperation, ? extends TypedefDefOperation> alg) {
    this.obj = obj;
    this.alg = alg;
  }
}
