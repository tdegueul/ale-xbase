...
public class ExceptionDefOperationImpl extends ContainedOperationImpl implements ExceptionDefOperation {
  private ExceptionDef obj;
  ...
  public ExceptionDefOperationImpl(final ExceptionDef obj, final IdlmmRevisitor<? extends ContainedOperation, ? extends ContainerOperation, ? extends ExceptionDefOperation, ? extends FieldOperation, ? extends IDLTypeOperation, ? extends NamedElementOperation, ? extends OperationDefOperation, ? extends ParameterDefOperation, ? extends PrimitiveDefOperation, ? extends TypedOperation, ? extends TypedefDefOperation> alg) {
    super(obj, alg);
    this.obj = obj;
    this.alg = alg;
  }
