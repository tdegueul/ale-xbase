...
import idl_exec.revisitor.operations.idl_exec.impl.IDLTypeOperationImpl;
import idlmm.revisitor.IdlmmRevisitor;
import org.csu.idl.idlmm.PrimitiveDef;

@SuppressWarnings("all")
public class PrimitiveDefOperationImpl extends IDLTypeOperationImpl implements PrimitiveDefOperation {
  private PrimitiveDef obj;
  ...
  public PrimitiveDefOperationImpl(final PrimitiveDef obj, final IdlmmRevisitor<? extends ContainedOperation, ? extends ContainerOperation, ? extends ExceptionDefOperation, ? extends FieldOperation, ? extends IDLTypeOperation, ? extends NamedElementOperation, ? extends OperationDefOperation, ? extends ParameterDefOperation, ? extends PrimitiveDefOperation, ? extends TypedOperation, ? extends TypedefDefOperation> alg) {
    super(obj, alg);
    this.obj = obj;
    this.alg = alg;
  }
