...
:
	(
		...
		rulePrimitiveDef
		{ after(grammarAccess.getParameterDefAccess().getContainedTypePrimitiveDefParserRuleCall_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		RULE_ID
		{ after(grammarAccess.getParameterDefAccess().getIdentifierIDTerminalRuleCall_2_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
