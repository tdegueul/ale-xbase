...
public class IotLuaXtextSyntacticSequencer extends AbstractSyntacticSequencer {

	protected IotLuaXtextGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (IotLuaXtextGrammarAccess) access;
