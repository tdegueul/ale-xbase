 ...
 * @generated
 */
public class FullhierarchicalfsmevalSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public FullhierarchicalfsmevalSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FullhierarchicalfsmevalPackage.ACTION_BIND_BLOCK: {
			...
			case FullhierarchicalfsmevalPackage.GUARD_BIND_EXP: {
