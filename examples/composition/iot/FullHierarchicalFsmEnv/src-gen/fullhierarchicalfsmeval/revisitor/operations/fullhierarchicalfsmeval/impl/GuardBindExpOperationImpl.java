...
public class GuardBindExpOperationImpl implements GuardBindExpOperation {
  ...
  public GuardBindExpOperationImpl(final GuardBindExp obj, final FullhierarchicalfsmevalRevisitor<ALVarRefOperation, ActionOperation, ActionBindBlockOperation, AndOperation, ArithOperation, ArithLitOperation, ArithMinusOperation, ArithOpOperation, ArithPlusOperation, AssignOperation, BinExpOperation, BlockOperation, CompositeStateOperation, ExpOperation, FalsOperation, GuardOperation, GuardBindExpOperation, InitialStateOperation, LitOperation, MachineOperation, NotOperation, OrOperation, PrintOperation, RegionOperation, StateOperation, StmtOperation, TransOperation, TruOperation, VarDeclOperation, VarRefOperation> alg) {
    this.obj = obj;
    this.alg = alg;
  }
  ...
  public boolean eval(final Context ctx) {
    fullhierarchicalfsmeval.converters.GuardToExpWithevalToeval convert =  new fullhierarchicalfsmeval.converters.GuardToExpWithevalToeval(ctx);
