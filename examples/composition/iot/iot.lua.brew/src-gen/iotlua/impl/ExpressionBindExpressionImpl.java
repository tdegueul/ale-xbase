 ...
 * </p>
 * <ul>
 *   <li>{@link iotlua.impl.ExpressionBindExpressionImpl#getDelegate <em>Delegate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionBindExpressionImpl extends EObjectImpl implements ExpressionBindExpression {
	...
	protected EClass eStaticClass() {
		return IotluaPackage.Literals.EXPRESSION_BIND_EXPRESSION;
	}
		...
		if (delegate != null && delegate.eIsProxy()) {
			...
			if (delegate != oldDelegate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IotluaPackage.EXPRESSION_BIND_EXPRESSION__DELEGATE, oldDelegate, delegate));
			}
		}
		return delegate;
	}
	...
	public void setDelegate(Expression newDelegate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IotluaPackage.EXPRESSION_BIND_EXPRESSION__DELEGATE, oldDelegate, delegate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IotluaPackage.EXPRESSION_BIND_EXPRESSION__DELEGATE:
