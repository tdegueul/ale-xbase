...
public class IntegerVariableToStatement_AssignmentWithexecuteToexecute {
  private final Context c;
  
  public IntegerVariableToStatement_AssignmentWithexecuteToexecute(final Context c) {
    this.c = c;
  }
