package evalgfsmboolexp.revisitor;

public interface EvalgfsmboolexpRevisitor<Boolexp__AndT extends Boolexp__BinaryExpT, Boolexp__BinaryExpT extends Boolexp__ExpT, Boolexp__ExpT, Boolexp__FalsT extends Boolexp__LitT, Gfsm__FinalStateT extends Gfsm__StateT, Gfsm__GuardT, Evalgfsmboolexp__GuardBindT extends Gfsm__GuardT, Gfsm__InitialStateT extends Gfsm__StateT, Boolexp__LitT extends Boolexp__ExpT, Gfsm__MachineT, Boolexp__OrT extends Boolexp__BinaryExpT, Gfsm__StateT, Gfsm__TransitionT, Boolexp__TruT extends Boolexp__LitT>
	...
	Evalgfsmboolexp__GuardBindT guardBind(final evalgfsmboolexp.GuardBind it);
	...
	default Gfsm__GuardT $(final gfsm.Guard it) {
		if (it.getClass() == evalgfsmboolexp.impl.GuardBindImpl.class)
			return guardBind((evalgfsmboolexp.GuardBind) it);
		return null;
	}
	default Evalgfsmboolexp__GuardBindT $(final evalgfsmboolexp.GuardBind it) {
		return guardBind(it);
	}
