 ...
 * </p>
 * <ul>
 *   <li>{@link evalgfsmboolexp.impl.GuardBindImpl#getDelegate <em>Delegate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GuardBindImpl extends EObjectImpl implements GuardBind {
	...
	protected EClass eStaticClass() {
		return EvalgfsmboolexpPackage.Literals.GUARD_BIND;
	}
		...
		if (delegate != null && delegate.eIsProxy()) {
			...
			if (delegate != oldDelegate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EvalgfsmboolexpPackage.GUARD_BIND__DELEGATE, oldDelegate, delegate));
			}
		}
		return delegate;
	}
	...
	public void setDelegate(Exp newDelegate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EvalgfsmboolexpPackage.GUARD_BIND__DELEGATE, oldDelegate, delegate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EvalgfsmboolexpPackage.GUARD_BIND__DELEGATE:
