 ...
 * </p>
 * <ul>
 *   <li>{@link printgfsmboolexp.impl.GuardBindImpl#getDelegate <em>Delegate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GuardBindImpl extends EObjectImpl implements GuardBind {
	...
	protected EClass eStaticClass() {
		return PrintgfsmboolexpPackage.Literals.GUARD_BIND;
	}
		...
		if (delegate != null && delegate.eIsProxy()) {
			...
			if (delegate != oldDelegate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PrintgfsmboolexpPackage.GUARD_BIND__DELEGATE, oldDelegate, delegate));
			}
		}
		return delegate;
	}
	...
	public void setDelegate(Exp newDelegate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrintgfsmboolexpPackage.GUARD_BIND__DELEGATE, oldDelegate, delegate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PrintgfsmboolexpPackage.GUARD_BIND__DELEGATE:
