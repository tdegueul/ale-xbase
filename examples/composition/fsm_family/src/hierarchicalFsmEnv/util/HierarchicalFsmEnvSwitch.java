 ...
 * @generated
 */
public class HierarchicalFsmEnvSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public HierarchicalFsmEnvSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HierarchicalFsmEnvPackage.COMPOSITE_STATE: {
			...
			case HierarchicalFsmEnvPackage.REGION: {
