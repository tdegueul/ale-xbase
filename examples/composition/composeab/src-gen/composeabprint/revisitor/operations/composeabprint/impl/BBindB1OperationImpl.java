...
public class BBindB1OperationImpl implements BBindB1Operation {
  private composeabprint.BBindB1 obj;
  
  private ComposeabprintRevisitor<AOperation, BOperation, B1Operation, BBindB1Operation> alg;
  
  public BBindB1OperationImpl(final composeabprint.BBindB1 obj, final ComposeabprintRevisitor<AOperation, BOperation, B1Operation, BBindB1Operation> alg) {
    this.obj = obj;
    this.alg = alg;
  }
