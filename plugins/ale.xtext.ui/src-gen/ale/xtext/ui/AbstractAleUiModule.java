...
import ale.xtext.ide.contentassist.antlr.PartialAleContentAssistParser;
import ale.xtext.ide.contentassist.antlr.internal.InternalAleLexer;
import ale.xtext.ui.contentassist.AleProposalProvider;
import ale.xtext.ui.editor.AleEditor;
import ale.xtext.ui.labeling.AleDescriptionLabelProvider;
import ale.xtext.ui.labeling.AleLabelProvider;
import ale.xtext.ui.outline.AleOutlineTreeProvider;
import ale.xtext.ui.quickfix.AleQuickfixProvider;
import ale.xtext.validation.AleValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link AleUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractAleUiModule extends DefaultXbaseUiModule {

	public AbstractAleUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(ale.xtext.parser.antlr.internal.InternalAleLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalAleLexer.class).toProvider(LexerProvider.create(InternalAleLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return AleValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return AleLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(AleDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return AleOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return AleQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return AleProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialAleContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Ale Compare");
	}
