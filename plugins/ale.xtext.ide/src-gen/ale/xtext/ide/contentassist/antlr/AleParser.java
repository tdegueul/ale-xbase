...
public class AleParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AleGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getAleMethodAccess().getAlternatives(), "rule__AleMethod__Alternatives");
			builder.put(grammarAccess.getConcreteMethodAccess().getAlternatives(), "rule__ConcreteMethod__Alternatives");
			...
			builder.put(grammarAccess.getAleRootAccess().getGroup(), "rule__AleRoot__Group__0");
			builder.put(grammarAccess.getEcoreImportAccess().getGroup(), "rule__EcoreImport__Group__0");
			builder.put(grammarAccess.getAleImportAccess().getGroup(), "rule__AleImport__Group__0");
			builder.put(grammarAccess.getAleClassAccess().getGroup(), "rule__AleClass__Group__0");
			...
			builder.put(grammarAccess.getAleRootAccess().getNameAssignment_1(), "rule__AleRoot__NameAssignment_1");
			builder.put(grammarAccess.getAleRootAccess().getJavaImportsAssignment_2(), "rule__AleRoot__JavaImportsAssignment_2");
			builder.put(grammarAccess.getAleRootAccess().getEcoreImportAssignment_3(), "rule__AleRoot__EcoreImportAssignment_3");
			builder.put(grammarAccess.getAleRootAccess().getAleImportsAssignment_4(), "rule__AleRoot__AleImportsAssignment_4");
			builder.put(grammarAccess.getAleRootAccess().getClassesAssignment_5(), "rule__AleRoot__ClassesAssignment_5");
			builder.put(grammarAccess.getEcoreImportAccess().getUriAssignment_2(), "rule__EcoreImport__UriAssignment_2");
			builder.put(grammarAccess.getAleImportAccess().getRefAssignment_2(), "rule__AleImport__RefAssignment_2");
			builder.put(grammarAccess.getAleClassAccess().getAbstractAssignment_1(), "rule__AleClass__AbstractAssignment_1");
			builder.put(grammarAccess.getAleClassAccess().getNameAssignment_3(), "rule__AleClass__NameAssignment_3");
			builder.put(grammarAccess.getAleClassAccess().getMethodsAssignment_5(), "rule__AleClass__MethodsAssignment_5");
			...
			builder.put(grammarAccess.getOverrideMethodAccess().getParamsAssignment_4_1_1(), "rule__OverrideMethod__ParamsAssignment_4_1_1");
			builder.put(grammarAccess.getOverrideMethodAccess().getBlockAssignment_6(), "rule__OverrideMethod__BlockAssignment_6");
