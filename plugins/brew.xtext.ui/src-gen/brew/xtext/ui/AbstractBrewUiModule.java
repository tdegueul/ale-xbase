...
import brew.xtext.ide.contentassist.antlr.BrewParser;
import brew.xtext.ide.contentassist.antlr.PartialBrewContentAssistParser;
import brew.xtext.ide.contentassist.antlr.internal.InternalBrewLexer;
import brew.xtext.ui.contentassist.BrewProposalProvider;
import brew.xtext.ui.labeling.BrewDescriptionLabelProvider;
import brew.xtext.ui.labeling.BrewLabelProvider;
import brew.xtext.ui.outline.BrewOutlineTreeProvider;
import brew.xtext.ui.quickfix.BrewQuickfixProvider;
...
/**
 * Manual modifications go to {@link BrewUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractBrewUiModule extends DefaultXbaseUiModule {

	public AbstractBrewUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(brew.xtext.parser.antlr.internal.InternalBrewLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalBrewLexer.class).toProvider(LexerProvider.create(InternalBrewLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return BrewLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(BrewDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return BrewOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return BrewQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return BrewProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialBrewContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Brew Compare");
	}
