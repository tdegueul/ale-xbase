    ...
    String _xblockexpression = null;
    {
      ...
      _builder_1.append("Revisitor");
      {
        ...
        for(final EClass clazzS : _sortBy) {
          ...
          String _operationInterfacePath = this.graphUtil.operationInterfacePath(clazzS, _name_1);
      ...
      _builder_1.append("Revisitor");
      {
        ...
        for(final EClass clazzS_1 : _sortBy_1) {
          ...
          String _name_3 = _matchingRoot_1.getName();
          String _operationInterfacePath_1 = this.graphUtil.operationInterfacePath(clazzS_1, _name_3);
      ...
      _builder_1.newLine();
      {
        ...
        for(final AleClass parent_1 : _superClass_1) {
          ...
          String _name_4 = parent_1.getName();
          String _firstUpper_6 = StringExtensions.toFirstUpper(_name_4);
