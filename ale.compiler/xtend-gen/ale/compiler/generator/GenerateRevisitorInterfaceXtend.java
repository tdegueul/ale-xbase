        ...
        for(final Pair<EClass, List<EClass>> dollarRoot : classPlusItsChildren) {
            ...
            for(final EClass subClass : _filter_4) {
              {
                ...
                if (_lessEqualsThan) {
                  ...
                  CharSequence _classifierFullPath = this.javaPathUtil.classifierFullPath(subClass);
          ...
          }
          {
            ...
            if (_isAbstract) {
              ...
              String _name_12 = _key_4.getName();
