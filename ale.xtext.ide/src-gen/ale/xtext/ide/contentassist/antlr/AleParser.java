		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAbstractMethodAccess().getGroup_5_1(), "rule__AbstractMethod__Group_5_1__0");
					...
					put(grammarAccess.getRootAccess().getImportSectionAssignment_3(), "rule__Root__ImportSectionAssignment_3");
					put(grammarAccess.getRootAccess().getImportEcoreAssignment_4(), "rule__Root__ImportEcoreAssignment_4");
					put(grammarAccess.getRootAccess().getImportsAleAssignment_5(), "rule__Root__ImportsAleAssignment_5");
					put(grammarAccess.getRootAccess().getClassesAssignment_6(), "rule__Root__ClassesAssignment_6");
					...
					put(grammarAccess.getAleClassAccess().getMethodsAssignment_4(), "rule__AleClass__MethodsAssignment_4");
					put(grammarAccess.getAbstractMethodAccess().getTypeAssignment_2(), "rule__AbstractMethod__TypeAssignment_2");
					put(grammarAccess.getAbstractMethodAccess().getNameAssignment_3(), "rule__AbstractMethod__NameAssignment_3");
					put(grammarAccess.getAbstractMethodAccess().getParamsAssignment_5_0(), "rule__AbstractMethod__ParamsAssignment_5_0");
					put(grammarAccess.getAbstractMethodAccess().getParamsAssignment_5_1_1(), "rule__AbstractMethod__ParamsAssignment_5_1_1");
					put(grammarAccess.getDefMethodAccess().getTypeAssignment_1(), "rule__DefMethod__TypeAssignment_1");
					put(grammarAccess.getDefMethodAccess().getNameAssignment_2(), "rule__DefMethod__NameAssignment_2");
					put(grammarAccess.getDefMethodAccess().getParamsAssignment_4_0(), "rule__DefMethod__ParamsAssignment_4_0");
					put(grammarAccess.getDefMethodAccess().getParamsAssignment_4_1_1(), "rule__DefMethod__ParamsAssignment_4_1_1");
					put(grammarAccess.getDefMethodAccess().getBlockAssignment_6(), "rule__DefMethod__BlockAssignment_6");
					...
					put(grammarAccess.getOverrideMethodAccess().getParamsAssignment_4_0(), "rule__OverrideMethod__ParamsAssignment_4_0");
					put(grammarAccess.getOverrideMethodAccess().getParamsAssignment_4_1_1(), "rule__OverrideMethod__ParamsAssignment_4_1_1");
					put(grammarAccess.getOverrideMethodAccess().getBlockAssignment_6(), "rule__OverrideMethod__BlockAssignment_6");
