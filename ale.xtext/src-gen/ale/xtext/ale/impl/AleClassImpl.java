 ...
 *   <li>{@link ale.xtext.ale.impl.AleClassImpl#getSuperClass <em>Super Class</em>}</li>
...
public class AleClassImpl extends MinimalEObjectImpl.Container implements AleClass
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlePackage.ALE_CLASS__NAME, oldName, name));
  }
